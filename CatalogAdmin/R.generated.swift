...
struct R {
  ...
  struct segue {
    ...
    static var storeListings: String { return "storeListings" }
  }
  ...
  struct storyboard {
    ...
    struct main {
      ...
      static func validateImages() {
        assert(UIImage(named: "ProductPlaceholder") != nil, "[R.swift] Image named 'ProductPlaceholder' is used in storyboard 'Main', but couldn't be loaded.")
      }
